...
-   **Glucose concentration (X-axis):** The amount of sugar in blood. In
    a healthy body, this remains steady within a tight range. High
    values indicate the body isn't metabolizing glucose correctly.

-   **Serum Insulin (Y-axis):** The amount of insulin produced by the
    body to break down sugar. Normal insulin levels should neither be
    too high nor too low.

-   **Genetic Risk Index (dot size and slider):** The genetic risk of
    getting diabetes based on family history. The larger the circle, the
    higher the risk.

The plot is separated into two facets for better readability as there
are a lot of dots and they tend to overlap with each other. The slider
allows you to sort the dots by range.
...
Through the slider, we can visualize the role of genetics in the
...
remain healthy, highlighting how a healthy lifestyle can override
genetic predisposition.

The plot empties out quickly as you slide toward the highest values,
indicating that extreme genetic disposition is rare among the Pima
Indians. This scarcity implies that for the majority of the population,
environment plays a more dominant role than heredity in determining
diabetes outcomes.
